    ...
    return (
        ...
        >
            <SliderPrimitive.Track
                ...
                className="h-2 bg-muted rounded-full data-horizontal:h-1 data-vertical:w-1 relative grow overflow-hidden data-horizontal:w-full data-vertical:h-full"
            ...
            {Array.from({ length: _values.length }, (_, index) => (
                <SliderPrimitive.Thumb
                    ...
                    key={index}
                    style={{ backgroundColor: "var(--color-text-special)" }}
